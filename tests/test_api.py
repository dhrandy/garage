...
def test_vehicle_specs_tab_api_and_token_write(tmp_path):
    ...
    with TestClient(main.app) as admin:
        ...
        saved=admin.put('/api/vehicles/1/specs',json={'engine':'2.0L inline-4','transmission':'5-speed manual','drivetrain':'RWD','curb_weight':'2,116 lb','displacement':'1.6L','mpg_city':'22','mpg_highway':'30','oil_type':'10W-30','oil_capacity':'3.4 qt','battery_group':'51R','spark_plugs':'NGK BKR6E-11','wiper_sizes':'18 / 18','coolant_type':'ethylene glycol','brake_fluid':'DOT 3','air_filter_part_number':'CA7598','wheel_lug_torque':'80 lb-ft','wheel_size':'15 × 6 in'})
